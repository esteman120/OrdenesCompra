    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6InU0T2ZORlBId0VCb3NIanRyYXVPYlY4NExuWSIsImtpZCI6InU0T2ZORlBId0VCb3NIanRyYXVPYlY4NExuWSJ9..Nsfb4GEGob86JgcoI2xL8rYMELNYW4J67u1DhTdMxoMlR9RZs3rCMG7X8iN2umd4WHTz5UAqh3p6eEzVWdKRTLW9rEmyqO3rPoiyeZ_N_9C4AkHHXhzLfaVZ8YSdah3tLBUh14s5-mp17-7KoChV0RCcWiBm9wVPKcM3mUaf3nMh2yw59FuYwhEtgFwpY4HRliSZ92dCKMRKxszGfVo6BDR7a1u707H3UOZMPh6eW4BWOtJ7o9e0rjSTPJ6DxUrxuN57NwnhH3frXRRngubmT_8n3FlfX7BkHnMQsSX4FcVvQ7yCSp5V6551-AJN5QDcCT9a2HuJ2HELTWzsBEZ64g'
            }
        }, environment.urlWeb);
    ...
    public ObtenerConfiguracionConPostGH() {
        const configuracionSharepoint = sp.configure({
            headers: {
                'Accept': 'application/json; odata=verbose',
                'Content-Type': 'application/json;odata=verbose',
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6InU0T2ZORlBId0VCb3NIanRyYXVPYlY4NExuWSIsImtpZCI6InU0T2ZORlBId0VCb3NIanRyYXVPYlY4NExuWSJ9..N6YysGETQzWe991xYoJIemjMgEJRcbyaDQAoYaPVwCxBJGIQpEr1pQvkfRjFaHuldopIZkNlMa54i8hLiRGTwk188VEAFutJ5kwWjpdu7a3SwkyVnkc0d_KX9fHq-6_dW32BG-WVXfcGubqnW5eoMhTYD60y5Ss0mBafK7YxOsyR3Ifyv6CQlAEgF1Zac7mrBo-gut8WZsBr-xq5F-7cKiB1gd-gFq4AVYI_J6H-5V8eJ5yKj6mLmJMidJ8SfGbOpN1SFrfnGrgPyyQ5w-wCRvXk37gie9XFjKCZ5aUDj3xRyh-FVYsVajEh3vjMn0SpynLCoarC-CjwbjhtLTbBpw' 
            }
        }, environment.urlWebGH);
