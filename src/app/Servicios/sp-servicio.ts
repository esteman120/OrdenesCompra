    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = sp.configure({
            headers: {
                ...
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6ImppYk5ia0ZTU2JteFBZck45Q0ZxUms0SzRndyIsImtpZCI6ImppYk5ia0ZTU2JteFBZck45Q0ZxUms0SzRndyJ9..roN9sgz5lU2xdgSOEYD2z6WGhdwqMjGZIxzPOZgaeZtIM3MSDJ1zuhGLnO7m_POhiVIx2rgOo2lKQlfBAUP8frBSURYMBr0yvNf8Y2LQqdtEwHrQ29IAw6ARsPtOX9jIUUcsQ2ImcNPp_EqrFsCbktsiUirxd7fIoPpgB_SuUjBYZypiAUSXWpxQWIw6dEwA3zQB0lfC39cEOMfdSDPd_mjA8gusPU3CBb1k2az4bvQqG--JMndSHBr9vrcZ2naQtulBm8P236uUertpY4NWN_57Ro8GbvQRwLKzHYUriv7nsQp5yvo-r01g2ivz4FPDmqJIPaE701VAIOVCr6Q0pA'
            }
        }, environment.urlWeb);
    ...
    public ObtenerConfiguracionConPostGH() {
        const configuracionSharepoint = sp.configure({
            headers: {
                'Accept': 'application/json; odata=verbose',
                'Content-Type': 'application/json;odata=verbose',
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6ImppYk5ia0ZTU2JteFBZck45Q0ZxUms0SzRndyIsImtpZCI6ImppYk5ia0ZTU2JteFBZck45Q0ZxUms0SzRndyJ9..d8OtQtRdEGJYQOzfG2XvEFFMFPOHtCJY0nj77vARdtJMqy4yYZuKANyzBDE2ss69ZYqRH5jynHnVm8artLXYGg9YQ6QiDC3ANgUB2_T1m1ci5IDdhJ8RshlyrbUS_-5tpCqEqwEc8eoVnC92wut_DtN1wMm2tjYD0Mpq0p9RIs5YzrO5GgEmvQZtscKM5QVP_V4f82Bq8NzgETnbho5eBiNgw4V5y0fq-U-mjlwCBo6w28IiZN3Qb-V2YGiJHgQod_d8rHV5AcDYEzlHYAeUFaXZ3JJAz8R4nC6R4Khv0HE-1XelqfJnEEvoW9Cv-ibfaA6G1NDQEj8-sFSHK1nb1w' 
            }
        }, environment.urlWebGH);
